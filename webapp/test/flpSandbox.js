		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pre Examen",
									"targetURL": "#pruebapreexamen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pruebapreexamen-display": {
								"semanticObject": "pruebapreexamen",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=prueba.preexamen",
									"url": sap.ui.require.toUrl("prueba/preexamen")
								}
							}
						}
					}
